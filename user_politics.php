...
<nav class="navbar navbar-inverse" style="z-index: 1;">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a style="background-color:#808080" href="user_politics.php" class="link-buttons">Politics</a></li>
        ...
        <article id="article-1">
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: LinkedIn | <a target="_blank" href="user_credits.php#pol1" style="color:#F6C90E">View full credits</a></p>
            </div>
        ...
        <article>
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: Manila Bulletin | <a target="_blank" href="user_credits.php#pol2" style="color:#F6C90E">View full credits</a></p>
            </div>
