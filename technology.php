...
<html>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a style="background-color:#808080" href="technology.php" class="link-buttons">Technology</a></li>
        ...
        <article id="article-1">
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: TED | <a target="_blank" href="credits.php#tech1" style="color:#F6C90E">View full credits</a></p>
            </div>
        ...
        <article>
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: Software Design Solutions (SDS) | <a target="_blank" href="credits.php#tech2" style="color:#F6C90E">View full credits</a></p>
            </div>
