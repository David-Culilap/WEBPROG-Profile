...
<html>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a style="background-color:#808080" href="sports.php" class="link-buttons">Sports</a></li>
        </ul>
        ...
        <article id="article-1">
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: ABC News | <a target="_blank" href="credits.php#sport1" style="color:#F6C90E">View full credits</a></p>
            </div>
