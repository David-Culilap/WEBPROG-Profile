...
<html>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="environment.php" class="link-buttons" style="background-color:#808080">Environment</a></li>
        ...
        <article id="article-1">
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: VODzilla | <a target="_blank" href="credits.php#env1" style="color:#F6C90E">View full credits</a></p>
            </div>
        ...
        <article>
            <div>
                ...
                <p style="color:#F6C90E; padding:0; margin:0">Image by: NPSEC | <a target="_blank" href="credits.php#env2" style="color:#F6C90E">View full credits</a></p>
            </div>
